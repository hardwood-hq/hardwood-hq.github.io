...
|--------|---------------------------|----------|-----------------------|----------------------------------------------|-------------|--------|-----------------------|
| Added  | **`static`** **`public`** |          | **[`AvroRowReader`]** | **`createRowReader`**([`ParquetFileReader`]) |             |        | ![Method added to public class] |
| Added  | **`static`** **`public`** |          | **[`AvroRowReader`]** | **`createRowReader`**([`ParquetFileReader`], [`FilterPredicate`]) |  |  | ![Method added to public class] |
| Added  | **`static`** **`public`** |          | **[`AvroRowReader`]** | **`createRowReader`**([`ParquetFileReader`], [`ColumnProjection`]) |  |  | ![Method added to public class] |
| Added  | **`static`** **`public`** |          | **[`AvroRowReader`]** | **`createRowReader`**([`ParquetFileReader`], [`ColumnProjection`], [`FilterPredicate`]) |  |  | ![Method added to public class] |
...
*Generated on: 2026-06-05 09:26:55.093+0000*.
