...
;
wasmImports.jsbody = {
	'_DiveWasm.exportKeyHandler___Consumer_V' : (...args) => (function(handler){
		try{
			globalThis.__diveKey = handler;
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_DiveWasm.exportLoadFile___Runnable_V' : (...args) => (function(handler){
		try{
			globalThis.__loadFile = handler;
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_DiveWasm.readCols___I' : (...args) => (function(){
		try{
			return (typeof globalThis.__cols === 'number') ? globalThis.__cols : 0;
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_DiveWasm.readInputStr___String' : (...args) => (function(){
		try{
			return (typeof globalThis.__inputStr === 'string') ? globalThis.__inputStr : '';
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_DiveWasm.readRows___I' : (...args) => (function(){
		try{
			return (typeof globalThis.__rows === 'number') ? globalThis.__rows : 0;
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_DiveWasm.writeOutput___String_V' : (...args) => (function(text){
		try{
			globalThis.__output = text;
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
